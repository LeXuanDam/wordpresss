...
<head>
    ...
    <link rel="icon" href="<?php echo get_template_directory_uri() ?>/img/trangchu/appicon/avatar.png">
    <title>Dream Kingdom - Yume 100 VN</title>
    <META NAME="description" CONTENT="Dream Kingdom - Yume 100 VN">
</head>
...
<style>
    ...
    #thongbao_1::-webkit-scrollbar {
        width: 5px;
    }

    /* Track */
    #thongbao_1::-webkit-scrollbar-track {
        background: #ee5d67;
    ...
    /* Handle */
    #thongbao_1::-webkit-scrollbar-thumb {
        background: #9c4488;
        border-radius: 10px;
    }
...
<div class="content" style="background-image: url('<?php echo get_template_directory_uri() ?>/img/trangchu/background.png'); background-size: 100% 100%">
    <div id="main">
        <div id="menu" style="width: 100%;position: relative;font-size: 1.2vw">
            <img src="<?php echo get_template_directory_uri() ?>/img/trangchu/background_menu.png" width="100%"
                 style="margin-top: 0.5%">
            <div style="position: absolute; top: 50%;  transform: translateY(-50%);color: white; padding: 0"
                 class="row col-xs-8 col-xs-offset-2 col-sm-8 col-sm-offset-2">
                <span><img width="12%" src="<?php echo get_template_directory_uri() ?>/img/trangchu/menu/logo.png"></span>
                <span style="margin-right: 3%"><a href="">TRANG CHỦ</a></span>
                <span style="margin-right: 3%"><a data-toggle="modal" data-target="#cotTruyen" href="">CỐT TRUYỆN</a></span>
                <span style="margin-right: 3%"><a href="#thongbao">THÔNG BÁO</a></span>
                <span style="margin-right: 3%"><a href="#gioithieu">HỖ TRỢ</a></span>
                <span style="margin-right: 3%"><a href="">NHÂN VẬT</a></span>
                <span><a href="https://fujigame.vn/helpNapthe">NẠP NGAY</a></span>
            </div>
        </div>
        <div id="dreamkingdom">
            <img src="<?php echo get_template_directory_uri() ?>/img/trangchu/dreamKingdom.png" width="100%"
                 style="margin-top: -5%">
        </div>
        <div style="position: absolute" class="col-xs-12 col-sm-12">
            <div id="appIcon" class="row col-xs-5 col-xs-offset-7 col-sm-5 col-sm-offset-7"
                 style="margin-top: -3%;margin-left: 61%">
                <div class="col-xs-3 col-sm-3"><img
                            src="<?php echo get_template_directory_uri() ?>/img/trangchu/icon.png"
                            width="130%"></div>
                <div class="col-xs-4 col-sm-4" style="margin-left: 5%">
                    <div><a href="https://goo.gl/8n8FSm"><img src="<?php echo get_template_directory_uri() ?>/img/trangchu/appicon/ios.png" width="140%"></a></div>
                    <div><a href="https://goo.gl/Gtrkv8"><img src="<?php echo get_template_directory_uri() ?>/img/trangchu/appicon/android.png" width="140%" style="margin-top: 4%"></a></div>
                </div>
            </div>
            <div class="col-xs-10 col-sm-10 col-xs-offset-1 col-sm-offset-1" id="topbanner"
                 style="margin-top: 3%;padding: 0">
                <a href="#" data-toggle="modal" data-target="#giftcode"><img class="col-xs-4 col-sm-4" src="<?php echo get_template_directory_uri() ?>/img/trangchu/topbanner/giftcode.png" style="" width="100%"></a>
                <a href="#" id="playvideo" data-toggle="modal" data-target="#video"><img id="image" class="col-xs-4 col-sm-4" src="<?php echo get_template_directory_uri() ?>/img/trangchu/topbanner/yume100.png" style="" width="100%"></a>
                <a href="http://fujigame.vn"><img class="col-xs-4 col-sm-4" src="<?php echo get_template_directory_uri() ?>/img/trangchu/topbanner/dangky.png" style="" width="100%"></a>
            </div>
        </div>
        <div id="thongbao" style="margin-top:25%; color: white">
            <div class="col-xs-10 col-xs-offset-1" style="position: relative">
                <img src="<?php echo get_template_directory_uri() ?>/img/trangchu/thongbao/header.png" width="100%">
                <p style="font-size: 3vw;position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                    THÔNG BÁO</p>
            </div>
            <div>

                <div style="position: relative" class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1">
                    <img src="<?php echo get_template_directory_uri() ?>/img/trangchu/thongbao/background1.png"
                         width="100%" class="row">
                    <div class="col-sm-6 col-xs-6" id="thongbao_1"
                         style="position: absolute;z-index: 2;left: 2%;top:10%;overflow: hidden;height: 85%">
                        <div>
                            <?php
                            $args = array('cat' => 1 ,'orderby' => 'id','order' => 'desc', 'posts_per_page' => 1, 'post_status' => 'publish');
                            $headPost = get_posts($args);
                            foreach ($headPost as $post){
                            setup_postdata($post);
                            if (get_field('thumb_img') != null) { ?>
                                <img src="<?= get_field("thumb_img"); ?>" width="100%"  height="66%" class="row">
                            <?php } else {
                                ?>
                                <img src="<?php echo get_template_directory_uri() ?>/img/trangchu/thongbao/avatar1.png"
                                     width="100%"  height="66%" class="row">
                                <?php
                            } ?>
                        </div>
                        <div style="font-size: 1.5vw;">
                            <div>
                                <a href="#" data-toggle="modal"
                                   data-target="#Tbao<?php echo $post->ID ?>"><p
                                            style="font-size: 1.5vw">
                                        <?php echo $post->post_title ?></p>
                                </a>
                            </div>
                            <div style="font-size: 1vw;text-align: justify;padding-right: 20px">
                                <?php
                                the_excerpt();
                    ...
                    <div id="noiDungThongBao"
                         style="position: absolute; top:10%; overflow-y: auto;height: 85%; overflow-x:hidden;width: 45% "
                         class="col-xs-5 col-xs-offset-6 col-sm-offset-6 col-sm-5">
                        <?php
                        $args = array('cat' => 1, 'orderby' => 'id', 'order' => 'desc', 'posts_per_page' => 20, 'post_status' => 'publish');
                            ...
                            <div class="row" style="margin-bottom: 3%">
                                <div class="col-sm-3 col-xs-3" >
                                    <?php if (get_field('thumb_img') != null) { ?>
                                        <img width="100%" height="auto" src="<?= get_field('thumb_img') ?>">
                                    <?php } else {
                                        ?>
                                        <img width="100%" height="auto"
                                             src="<?php echo get_template_directory_uri() ?>/img/trangchu/thongbao/avatar.png">
                                        <?php
                                    } ?>
                                </div>
                                <div class="col-sm-9 col-xs-9" style="color: white; padding: 0; margin-top: -1%">
                                    <div><a href="#" data-toggle="modal"
                                            data-target="#Tbao<?php echo $post->ID ?>">
                                            <p style="font-size: 1.5vw"><?php echo $post->post_title ?></p>
                                        </a></div>
                                    <div style="font-size: 1vw"><?php the_excerpt();
                                        //                                        if (strlen($post->post_content) > 200) {
                                        //                                            $post->post_content = substr($post->post_content, 0, 200) . "...";
                                        //                                        }
        ...
        <div class="row" id="gioithieu" style="margin-top:107%; color: white">
            <div class="col-xs-7 col-xs-offset-1">
                <div style="position: relative">
                    <img src="<?php echo get_template_directory_uri() ?>/img/trangchu/gioithieu/header.png"
                         width="100%">
                    <div style="font-size: 2.9vw; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
                        GIỚI THIỆU
                    </div>
                </div>
                <div style="position: relative">
                    <img src="<?php echo get_template_directory_uri() ?>/img/trangchu/gioithieu/background.png"
                         width="100%">
                    <p class="col-sm-6 col-sm-offset-5 col-xs-6 col-xs-offset-5"
                       style="font-size: 1vw;position: absolute; top:0;text-align: justify">Đang chờ đón bạn tại vương quốc Giấc Mơ,là 100 chàng hoàng tử!
            ...
            <div class="col-xs-3">
                <div style="position: relative">
                    <img width="100%" src="<?php echo get_template_directory_uri() ?>/img/trangchu/hotro1/hotro.png">
                    <p style="font-size: 2vw;position: absolute;top:27%; left: 50%; transform: translateX(-50%);">HỖ
                        TRỢ</p>
                    <p style="font-size: 2vw; position: absolute; left: 30%; top:45%">0946.153.466</p>
                    <p style="font-size: 1.2vw; position: absolute; left: 30%; top:75%">support@fujigame.vn</p>
                </div>
                <div style="margin-top: 3%;max-height: 1000px">
                    <img width="95%" style="margin-left: 2.5%"
                         src="<?php echo get_template_directory_uri() ?>/img/trangchu/hotro1/fa.png">
                    <div style="width: 95%; margin-left: 2.5%; max-height: 500px;">
                        <div style="position: relative;width: 100%;height:70%;overflow: hidden;">
                            <div style="position: absolute;top:0;left: 0;width: 100%;overflow-x:auto" class="fb-page"
                                 data-href="https://www.facebook.com/vn.yume100" data-tabs="timeline"
                                 data-width="500px" data-height="50%" data-small-header="false"
                                 data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                                <blockquote cite="https://www.facebook.com/vn.yume100" class="fb-xfbml-parse-ignore"><a
                                            href="https://www.facebook.com/vn.yume100">Yume 100 Việt Nam</a>
                                </blockquote>
                            </div>
                        </div>
                    </div>
        ...
        <div id="footer" style="margin-top: 3%; color: white;position: relative">
            <img src="<?php echo get_template_directory_uri() ?>/img/trangchu/footer/background.png" width="100%">
            <div style="text-align: center;position: absolute; top: 50%; transform: translateY(-50%);"
                 class="col-xs-6 col-xs-offset-3 col-sm-offset-3 col-sm-6">
                <p style="font-size: 1vw"><a href="#" data-toggle="modal" data-target="#dieu_khoan">Điều khoản sử dụng</a> | <a data-toggle="modal" data-target="#quy_dinh" href="#">Quy định NPH</a></p>
                <p style="font-size: 1.2vw">FUJI GAME ĐỘC QUYỀN PHÁT HÀNH TẠI VIỆT NAM</p>
                <p style="font-size: 1vw">Tầng 7 tòa nhà Việt Tower, số 1 Thái Hà, phường Trung Liệt, quận Đống Đa, TP
                    Hà Nội.<br>
                    Giấy phép số 165/GP-BTTTT do Bộ Thông tin và Truyền thông cấp ngày 20/04/2017<br>
                    © GCREST, Inc. All rights reserved</p>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="video" role="dialog">
        <div class="col-xs-8 col-xs-offset-2 col-sm-8 col-sm-offset-2" style="margin-top: 10%">
    ...
    <div class="modal fade" id="cotTruyen" role="dialog">
        ...
        <div class=" col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
            <button style="border: 0;background-color: #808080" data-dismiss="modal">
                <img style="width:5%; position: absolute; top:7%; right:13%;z-index: 2"
                     src="<?php echo get_template_directory_uri() ?>/img/cottruyen/icon_back.png">
            </button>
            <img style="position: relative;width: 100%;z-index: 1"
                 src="<?php echo get_template_directory_uri() ?>/img/cottruyen/cottruyen.png">
            <div style="color: black; position: absolute; z-index: 2;top:25%;left:20%; height: 30%;overflow: auto"
                 id="scrollCottruyen" class="col-xs-8 col-sm-8 ">
                <div id="textcottruyen" style="text-align: center;overflow: auto; font-size: 1.3vw">
    ...
    <div class="modal fade" id="giftcode" role="dialog">
        ...
        <div class="col-sm-6 col-sm-offset-3 col-xs-8 col-xs-offset-2">
            <button style="border: 0;background-color: #808080" data-dismiss="modal">
                <img style="width:5%; position: absolute; top:5%; right:4%; z-index: 2"
                     src="<?php echo get_template_directory_uri() ?>/img/trangchu/giftcode/iconBack.png">
            </button>
            <div style="position: relative">
                <img style="width: 100%" src="<?php echo get_template_directory_uri() ?>/img/trangchu/giftcode/linkGiftcode.png">
                <p style="position: absolute; text-align: center;top: 5%; color: white; font-size: 2.3vw"
                   class="col-xs-12">GIFTCODE</p>
                <div style="position: absolute;top:20%;" class="col-xs-12 col-sm-12">

                    <form action="#" method="post">
                        <div class="col-xs-8 col-xs-offset-2 col-sm-8 col-sm-offset-2">
                            <p style="font-weight: bold; color: #670f11;">Email</p>
                            ...
                            <input required type="text" name="email" id="email" class="form-control"
                                   style="border-radius: 20px" placeholder="Nhập email">
                            <p style="font-weight: bold; color: #670f11; margin-top: 5%">Số điện
                                thoại</p>
                            <input type="text" name="phone" class="form-control" id="phone" style="border-radius: 20px"
                                   placeholder="Nhập số điện thoại">
                        </div>

                        <div style="text-align: center; margin-top: 3%" class="col-xs-12"><a href="#" id="submit" style="" type="submit">
                                <img width = "25%" src="<?php echo get_template_directory_uri() ?>/img/trangchu/giftcode/submit.png"></a>
                        </div>
    ...
    <div class="modal fade" id="giftcode2" role="dialog">
        ...
        <!-- Modal content-->
        <div class="col-sm-6 col-sm-offset-3 col-xs-3 col-xs-offset-3">
            <button style="border: 0;background-color: #808080" data-dismiss="modal">
                <img style="width:5%; position: absolute; top:5%; right:4%; z-index: 2"
                     src="<?php echo get_template_directory_uri() ?>/img/trangchu/giftcode/iconBack.png">
            </button>
            <div style="position: relative">
                <img style="width: 100%"
                     src="<?php echo get_template_directory_uri() ?>/img/trangchu/giftcode/giftcode2.png">
                <p style="position: absolute; text-align: center;top: 5%; color: white; font-size: 2.3vw"
                   class="col-xs-12">GIFTCODE</p>
                <div style="position: absolute; text-align: center;top:17%; font-weight: bold; color: #670f11;font-size: 1vw"
                     class="col-xs-10 col-xs-offset-1">
                    <p>Chúc mừng bạn đã báo danh thành công</p>
                    <p>BQT xin tặng bạn mã Code VIP </p>
                </div>
                <div style="position: absolute; top: 29%; left: 50%;transform: translateX(-50%);font-weight: bold; color:white; font-size: 2vw">
                    V4Q9ZUXA7A
                </div>
                <div style="position: absolute; text-align: center;top:37%; font-weight: bold; color: #670f11; font-size: 1vw"
                     class="col-xs-10 col-xs-offset-1">
    ...
    foreach ($myposts as $post) {
        ...
        <div class="modal fade" id="Tbao<?php echo $post->ID ?>" role="dialog">
            ...
            <div class="col-sm-8 col-sm-offset-2">
                <button style="border: 0;background-color: #808080" data-dismiss="modal">
                    <img style="width:5%; position: absolute; top:2%; right:2%;z-index: 2"
                         src="<?php echo get_template_directory_uri() ?>/img/thongbao/icon_back.png">
                </button>
                <img style="position: relative;width: 100%;z-index: 1"
                     src="<?php echo get_template_directory_uri() ?>/img/thongbao/thongbao.png">
                <div style="position: absolute; z-index: 2;top:20%;height: 75%;overflow: auto" id="scrollThongBao"
                     class="col-sm-10 col-sm-offset-1" >
                    <?php if (get_field('thumb_img') != null) { ?>
                        <img width="100%" height="45%" style="margin-bottom: 3%" class="col-sm-8 col-sm-offset-2"
                    ...
                    <div style="color: white;"
                         class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1">
                        <div>
                            <p style="text-align: center;font-size: 2vw;color: white"><?php echo $post->post_title?></p>

                            <p id="textthongbao"
                               style="text-align: justify;overflow: auto;font-size: 1vw"> <?php the_content(); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="dieu_khoan" role="dialog">
        ...
        <div class=" col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
            <button style="border: 0;background-color: #808080" data-dismiss="modal">
                <img style="width:5%; position: absolute; top:0; right:5%;z-index: 2"
                     src="<?php echo get_template_directory_uri() ?>/img/cottruyen/icon_back.png">
            </button>
            <img style="position: relative;width: 100%;z-index: 1"
                 src="<?php echo get_template_directory_uri() ?>/img/trangchu/thongbao/background1.png">
            <div style="color: white; position: absolute; z-index: 2;top:8%;left:20%; height: 80%;overflow: auto"
                 id="scrollCottruyen" class="col-xs-8 col-sm-8 ">
